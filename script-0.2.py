...
def generate_html_from_text(input_file, output_html):
    ...
    with open(output_html, 'w', encoding='utf-8') as html_file:
        ...
        html_file.write('    color: #555;\n')
        html_file.write('    margin: 0 0 10px 0;\n')
        html_file.write('    line-height: 1.4;\n')
        html_file.write('  }\n')
        html_file.write('  .description p {\n')
        html_file.write('    margin: 0 0 8px 0;\n')
        html_file.write('    line-height: 1.45;\n')
        html_file.write('  }\n')
        html_file.write('  hr {\n')
        html_file.write('    display: none;\n')  # убрал hr, т.к. теперь карточки с отступами
        html_file.write('  }\n')
        html_file.write('</style>\n')
            ...
            if match:
                ...
                if current_image is not None:
                    ...
                    if description_lines:
                        ...
                        html_file.write('    <p>' + description_lines[0] + '</p>\n')  # первая строка маленькая
